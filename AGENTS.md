...
> Auto-loaded by Codex at the start of every session. Source of truth for project conventions. When training data and this file conflict, this file wins.
...
**OpenAI as primary AI** — single API key, simple. Switching to Codex later is straightforward because we'll use Spring AI's abstractions.
